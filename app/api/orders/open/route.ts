  ...
  try {
    ...
    const decoded = orders.map((order) => {
      return {
        ...
        amount: {
          oriMakingAmount: order.amount.oriMakingAmount.toString(),
          oriTakingAmount: order.amount.oriTakingAmount.toString(),
          makingAmount: order.amount.makingAmount.toString(),
          takingAmount: order.amount.takingAmount.toString(),
        },
